...
public class Camera {
    ...
    /*
    *
    * Added for change to YamateCamera
    */
...
*/
                ...
                if (displaySize.x > displaySize.y) {
                    double scale = (double) displaySize.y / (double) map.getOutputSizes(SurfaceTexture.class)[0].getHeight();
                    mPreviewSize = new Size((int)(scale * map.getOutputSizes(SurfaceTexture.class)[0].getWidth()), (int)(scale * map.getOutputSizes(SurfaceTexture.class)[0].getHeight()));
                } else {
                    double scale = (double) displaySize.x / (double) map.getOutputSizes(SurfaceTexture.class)[0].getHeight();
                    mPreviewSize = new Size((int)(scale * map.getOutputSizes(SurfaceTexture.class)[0].getHeight()), (int)(scale * map.getOutputSizes(SurfaceTexture.class)[0].getWidth()));
                }
...
*/
    ...
    public void setCameraRotation() {
        ...
        Util.PiCoreLog("orientation:"+orientation+",mCameraRotation:"+mCameraRotation+",mIsPortraitDevice:"+mIsPortraitDevice);
    }
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        if (mNextVideoAbsolutePath == null || mNextVideoAbsolutePath.isEmpty()) {
            mNextVideoAbsolutePath = "/mnt/sdcard/DCIM/Yamate/"+ System.currentTimeMillis() + ".mp4";
        }
    ...
    public void startRecordingVideo() {
        ...
        //try {
            //closePreviewSession();
            //setUpMediaRecorder();
            //SurfaceTexture texture = mSurfaceTexture;//mTextureView.getSurfaceTexture();
            //assert texture != null;
